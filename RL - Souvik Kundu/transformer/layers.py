...
class DecoderLayer(nn.Module):
    def __init__(self, d_k, d_v, d_model, d_ff, n_heads, dropout=0.1):
        ...
        self.dec_self_attn = MultiBranchAttention(d_k, d_v, d_model, 2048, n_heads, dropout)
        self.dec_enc_attn = MultiBranchAttention(d_k, d_v, d_model, 2048, n_heads, dropout)
        self.pos_ffn = PoswiseFeedForwardNet(d_model, d_ff, dropout)
